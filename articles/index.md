...
- [Mapping buildings by construction year
  (BAG)](https://coeneisma.github.io/pdokr/articles/bag-buildings.md):
- [Combining with external data: school locations
  (DUO)](https://coeneisma.github.io/pdokr/articles/duo-schools.md):
